...
function(t, e, o) {
    ...
    function r(t) {
        ...
        for (var n = t; (n = n.parentNode) && n && 1 === n.nodeType;) {
            ...
            if ("undefined" == typeof r || null === r) return i.push(n),
            i;
            var a = r,
            f = a.overflow,
            l = a.overflowX,
        ...
        },
        {
            ...
            value: function(t) {
                if ("undefined" != typeof this.bindings && this.bindings[t]) {
                    for (var e = 0,
                    o = arguments.length,
                    i = Array(o > 1 ? o - 1 : 0), n = 1; n < o; n++) i[n - 1] = arguments[n];
        ...
        },
        {
            ...
            value: function() {
                ...
                if (this.enabled) {
                    ...
                    p = w(p, c),
                    u = w(u, g);
                    for (var m = h.left + u.left - p.left,
                    v = h.top + u.top - p.top,
                    ...
                    ["", "static"].indexOf(A.body.style.position) !== -1 && ["", "static"].indexOf(A.body.parentElement.style.position) !== -1 || (E.page.bottom = A.body.scrollHeight - v - r, E.page.right = A.body.scrollWidth - m - n),
        ...
        },
        {
            ...
            value: function(t) {
                ...
                if ("undefined" != typeof this.element.parentNode) {
                    ...
                    t.page)), !p) if (this.options.bodyElement) this.options.bodyElement.appendChild(this.element);
                    else {
                        for (var u = !0,
